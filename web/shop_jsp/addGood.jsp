                ...
                <div class="col-md-12" style="margin-top: 20px">
                    <div class="container-fluid">
                        <form action="addGood.action" method="post" enctype="MULTIPART/FORM-DATA">
                            ...
                            <div class="row" style="margin-top:10px;">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="input-group">
                                        ...
                                        <input name="good.name" type="text" class="form-control"
                            ...
                            <div class="row" style="margin-top:20px;">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="input-group">
                                        ...
                                        <input name="good.brand" type="text" class="form-control"
                                               aria-describedby="sizing-addon2"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-top:20px;">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="input-group">
                                        ...
                                        <input name="good.isRented" value="1" type="radio" checked="checked"
                                               style="margin-left: 20px">可租
                            ...
                            <div class="row" style="margin-top:20px;">
                                <div class="col-md-4 col-md-offset-1">
                                    <div class="input-group">
                                        ...
                                        <input name="good.currentPrice" type="text" class="form-control"
                                               aria-describedby="sizing-addon2"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-top:20px;">
                                <div class="col-md-4 col-md-offset-1">
                                    <div class="input-group">
                                        ...
                                        <input name="good.originalPrice" type="text" class="form-control"
                                               aria-describedby="sizing-addon2"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-top:20px;">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="input-group">
                                        ...
                                        <input name="goodParameter" type="text" class="form-control"
                                               aria-describedby="sizing-addon2"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <textarea name="good.description" rows="8"
                                              style="width: 100%;resize:none;border:inset 3px #000000"></textarea>
                                </div>
                            </div>
